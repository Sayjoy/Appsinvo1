...
<div class="help-block">Items will be used for only this invoice</div>
...
<div class="row">
   ...
   <div class="col-md-10" id="dynamicInput">
...
<div class="row">
    <div class="form-group col-md-6 mt-2">
        {!! Form::submit('Add to Cart', ['class'=>'btn btn-primary', 'name'=>'create']) !!}
    </div>
</div>
{!! Form::close() !!}
    ...
    function addInput(divName){
        if (counter == limit)  {
            ...
            newdiv.innerHTML = '<div class="row">' +
                                    ...
                                    '<div class="form-group col-md-2"> ' +
                                        '<label>Qty</label> ' +
                                        '<input type="text" id="qty'+counter+'"  class="form-control" name="qty[]" ' +
                                                'onchange="check_value(this)"  onclick="minusPrice(this)">' +
                                    '</div>' +
                                    ...
                                    '<div class="form-group col-md-3">' +
                                        '<label>Price (N)</label>' +
                                        '<input type="text" class="form-control" name="price[]" id="p'+counter+'" ' +
                                            'onchange="qtyFirst(this); numberFormat(this); addPrice(this)" onclick="minusPrice(this)">' +
                                    '</div>' +
                                '</div>';
